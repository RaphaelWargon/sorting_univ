...
dict_vars <- c('acces_rce'= 'Administrative autonomy',
               ...
               "publications_wins" =   'Publications',
               "citations_wins"='Citations',
               "nr_source_top_5pct_wins"="Top 5% journal publications",
               "nr_source_top_10pct_wins" ="Top 10% journal publications", 
               "nr_source_top_20pct_wins"="Top 20% journal publications",        
               "nr_source_mid_40pct_wins"="Middle 40% journal publications",        
               "nr_source_btm_50pct_wins"="Bottom 50% journal publications",
               "new_word_wins"  = "Avg #new words",                  
               "new_word_reuse_wins"    = "Avg #new words",          
               "new_phrase_wins"          = "Avg #new phrases",   
               "new_phrase_reuse_wins"   = "Avg #new phrases",
               "new_word_comb_wins"        = "Avg #new word combinations",        
               "new_word_comb_reuse_wins"  = "Avg #new word combinations",       
               "new_phrase_comb_wins"     = "Avg #new phrase combinations",        
               "new_phrase_comb_reuse_wins" = "Avg #new phrase combinations",     
               "total_new_word_wins"            = "Total #new word",   
               "total_new_word_reuse_wins"      = "Total #new word",
               "total_new_phrase_wins"           = "Total #new phrases",
               "total_new_phrase_reuse_wins"      = "Total #new phrases",
               "total_new_word_comb_wins"        = "Total #new word combinations", 
               "total_new_word_comb_reuse_wins"  = "Total #new word combinations",
               "total_new_phrase_comb_wins"        = "Total #new phrase combinations",
               "total_new_phrase_comb_reuse_wins"   = "Total #new phrase combinations",                           
